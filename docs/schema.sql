create table "digital-wallet".CURRENCY
(
...
create table "digital-wallet".CUSTOMER
(
    ID              BIGINT auto_increment
        primary key,
    IDATE           TIMESTAMP             not null,
...
CREATE MEMORY TABLE "digital-wallet"."WALLET"(
    "ID" BIGINT GENERATED BY DEFAULT AS IDENTITY SEQUENCE "digital-wallet"."SYSTEM_SEQUENCE_B4A51449_D636_44DD_9008_0A6566336720" NOT NULL,
    "IDATE" TIMESTAMP NOT NULL,
    "UDATE" TIMESTAMP,
    "STATUS" INTEGER DEFAULT 0 COMMENT '-1: deleted, 0:passive, 1:active' NOT NULL,
...
create table if not exists "digital-wallet".WALLET_TX
(
